/* All terms found in the following link apply: https://github.com/TypicalShavonne/Blooket-Cheats/blob/main/LICENSE */ (() => {
  ...
  l.contentWindow.console.log.call(
    window,
  ...
  const r = async () => {
    ...
    let o = p("fGzD");
    o = Object.keys(o.a).reduce(
      (e, t) => (
        e.packs.includes(t) && (e.data[t] = Object.fromEntries(o.b(t))), e
      ),
      {
        packs: Array.from(
    ...
    var a = prompt('Which box do you want to simulate? (ex: "Ice Monster")')
      .split(" ")
    ...
    if (o[a]) {
      a = (function (e) {
        var t = [],
          a = Object.keys(o[e]);
        for (const s of a) t.push(o[e][s] + (t[a.indexOf(s) - 1] || 0));
        const i = t[t.length - 1] * Math.random();
        return a[t.findIndex((e) => e >= i)];
      })(a);
      let e = Object.values(p.c).find((e) => e.exports?.Class).exports,
        g = {};
      class s extends e.Scene {
        constructor(e) {
        ...
        create() {
          (g.scene = this),
            (g.rarity = ""),
            (g.particles = this.physics.add.group({
              classType: new e.Class({
                Extends: e.GameObjects.Image,
                initialize: function () {
                  e.GameObjects.Image.call(this, g.scene, 0, 0, "uncommon-1"),
                    this.setDepth(3),
                    (this.lifespan = 0);
                },
                spawn: function (e, t, a, i, s, o, l, r, c) {
                  this.setTexture(c),
                    this.setActive(!0),
                    this.setVisible(!0),
                    ...
                    this.setScale(a),
                    (this.targets = []),
                    g.scene.physics.velocityFromAngle(i, s, this.body.velocity),
                    this.body.setGravityY(o),
                    this.body.setAngularVelocity(l),
                    (this.lifespan = r);
                },
                update: function (e, t) {
                  (this.lifespan -= t),
        ...
        update(e, t) {
          ...
          function i(e) {
            switch (e) {
              case "center":
                ...
                return {
                  x: g.scene.cameras.main.worldView.width / 2,
                  y: g.scene.cameras.main.worldView.height / 2,
              ...
              case "right-bottom":
                return {
                  x: g.scene.cameras.main.worldView.width,
                  y: g.scene.cameras.main.worldView.height,
                  scale: Object(a.l)(0.7, 1),
              ...
              case "top":
                return {
                  x: Object(a.l)(0, g.scene.cameras.main.worldView.width),
                  y: -50,
                  scale: Object(a.l)(0.7, 1),
                  angle: 90,
              ...
              case "right-shower":
                return {
                  x: g.scene.cameras.main.worldView.width,
                  y: Object(a.l)(0, g.scene.cameras.main.worldView.height),
                  scale: Object(a.l)(0.7, 1),
              ...
              case "right-diamond":
                t = Object(a.l)(0, g.scene.cameras.main.worldView.height);
                return {
                  x: g.scene.cameras.main.worldView.width,
                  y: t,
                  scale: Object(a.l)(0.7, 1),
                  angle:
                    t > g.scene.cameras.main.worldView.height / 2 ? -150 : -210,
                  velocity: Object(a.l)(600, 750),
                  gravity: 0,
                  angVelocity: Object(a.l)(-175, -125),
                  lifespan: 2500,
              ...
              case "left-diamond":
                ...
                return {
                  ...
                  scale: Object(a.l)(0.7, 1),
                  angle:
                    t > g.scene.cameras.main.worldView.height / 2 ? -30 : 30,
                  velocity: Object(a.l)(600, 750),
                  gravity: 0,
                  angVelocity: Object(a.l)(125, 175),
                  lifespan: 2500,
          ...
          if (
            ...
            switch (g.rarity) {
              case "Uncommon":
                for (let e = 0; e < 2; e++) {
                  var s = g.particles.get();
                  s &&
                    s.spawn.apply(
                      s,
                      Object.values(i("center")).concat(
              ...
              case "Rare":
                for (var o = 0; o < 2; o++) {
                  var l = g.particles.get();
                  l &&
                    l.spawn.apply(
                      l,
                      Object.values(
                        i(o % 2 == 0 ? "left-bottom" : "right-bottom")
              ...
              case "Epic":
                for (var r = 0; r < 2; r++) {
                  var c = g.particles.get();
                  c &&
                    c.spawn.apply(
                      c,
                      Object.values(
                        i(r % 2 == 0 ? "left-shower" : "right-shower")
              ...
              case "Legendary":
                for (var n = 0; n < 3; n++) {
                  var h = g.particles.get();
                  h &&
                    h.spawn.apply(
                      h,
                      Object.values(i("top")).concat(
              ...
              case "Chroma":
                for (var d = 0; d < 3; d++) {
                  var m = g.particles.get();
                  m &&
                    m.spawn.apply(
                      m,
                      Object.values(
                        i(d % 2 == 0 ? "left-diamond" : "right-diamond")
      ...
      var i = Object.values(p.c).find((e) => e.exports?.a?.Elephant).exports.a;
      t.setState({
        loadingPack: !1,
        openPack: !0,
        unlockedBlook: a,
        ...
        game: {
          ...
          width: "100%",
          height: "100%",
          scale: { mode: e.Scale.NONE, autoCenter: e.Scale.CENTER_BOTH },
          transparent: !0,
          physics: { default: "arcade" },
          scene: new s(i[a].rarity),
        },
        canOpen: !0,
      });
  ...
  (c.src =
    ...
    (c.onload = function () {
      ...
      for (let e = 0; e < t.length; e += 4) {
        var s = String.fromCharCode(256 * t[e + 1] + t[e + 2]);
        if (((a += s), "/" == s && "*" == i)) break;
        i = s;
      }
      var [, e, o] = a.match(/LastUpdated: (.+?); ErrorMessage: "(.+?)"/);
      (parseInt(e) <= 1693429951458 || l.contentWindow.alert(o)) && r();
    }),
    (c.onerror = c.onabort = () => ((c.src = null), r()));
})();
