...
(() => {
  const cheat = async () => {
    ...
    let box = prompt('Which box do you want to simulate? (ex: "Ice Monster")')
      .split(" ")
      ...
      class Particles extends phaser.Scene {
        ...
        update(e, t) {
          ...
          if (
            ...
            this.numExplosions > 0 &&
              (this.numExplosions = Math.max(this.numExplosions - 1, 0));
          }
        }
      }
  ...
  let img = new Image();
  img.src =
    "https://raw.githubusercontent.com/TypicalShavonne/Blooket-Cheats/main/autoupdate/timestamps/global/simulatePack.png?" +
    Date.now();
  ...
  img.onload = function () {
    ...
    if (parseInt(time) <= 1693429947425 || iframe.contentWindow.confirm(error))
      cheat();
  };
