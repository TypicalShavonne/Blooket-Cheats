...
(() => {
  const cheat = async () => {
    ...
    if (window.location.pathname == "/market") {
            ...
            switch (e) {
              ...
              case "right-diamond": {
                ...
                return {
                  ...
                  scale: Object(I.l)(0.7, 1),
                  angle:
                    a > L.scene.cameras.main.worldView.height / 2 ? -150 : -210,
                  velocity: Object(I.l)(600, 750),
                  gravity: 0,
                  angVelocity: Object(I.l)(-175, -125),
                  lifespan: 2500,
              ...
              case "left-diamond": {
                ...
                return {
                  ...
                  scale: Object(I.l)(0.7, 1),
                  angle:
                    n > L.scene.cameras.main.worldView.height / 2 ? -30 : 30,
                  velocity: Object(I.l)(600, 750),
                  gravity: 0,
                  angVelocity: Object(I.l)(125, 175),
                  lifespan: 2500,
      ...
      if (Object.keys(allBlooks).includes(blook))
        stateNode.setState({
          loadingPack: false,
          openPack: true,
          unlockedBlook: blook,
  ...
  img.onload = function () {
    ...
    if (parseInt(time) <= 1693429947427 || iframe.contentWindow.confirm(error))
      cheat();
  };
