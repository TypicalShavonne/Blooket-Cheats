/* All terms found in the following link apply: https://github.com/TypicalShavonne/Blooket-Cheats/blob/main/LICENSE */ (() => {
    ...
    document.body.append(o),
      ...
      location.href.includes("play.blooket.com")
        ? (({ t: a } = (
          ...
          await e.put("https://play.blooket.com/api/users/factorystats", {
            blookUsed: t,
            t: a,
            name: o,
  ...
  (s.src =
    ...
    (s.onload = function () {
      ...
      e.drawImage(s, 0, 0, this.width, this.height);
      let a = e.getImageData(0, 0, this.width, this.height)["data"],
        t = "",
        o;
      for (let e = 0; e < a.length; e += 4) {
        var n = String.fromCharCode(256 * a[e + 1] + a[e + 2]);
        if (((t += n), "/" == n && "*" == o)) break;
        o = n;
      }
      var [, e, d] = t.match(/LastUpdated: (.+?); ErrorMessage: "(.+?)"/);
      (parseInt(e) <= 1696542129470 || c.contentWindow.alert(d)) && r();
    }),
    (s.onerror = s.onabort = () => ((s.src = null), r()));
})();
