/* All terms found in the following link apply: https://github.com/TypicalShavonne/Blooket-Cheats/blob/main/LICENSE */ (() => {
  ...
  const r = async () => {
    ...
    if (
      ...
      let g = webpackJsonp.push([
        ...
        i = e.find((e) => e.exports.a?.Breakfast).exports.a,
        a = Object.entries(t).reduce(
          (e, [t, a]) => (i[a.realSet || a.set] && (e[t] = a), e),
          {}
        );
      o = Object.values(
      ...
      let s = Object.values(g.c).find((e) => e.exports?.Class).exports,
        p = new (function () {
          (this.scene = null), (this.particles = null), (this.rarity = null);
        })();
      class r extends s.Scene {
        constructor(e) {
        ...
        create() {
          (p.scene = this),
            ...
            (p.particles = this.physics.add.group({
              classType: new s.Class({
                Extends: s.GameObjects.Image,
                initialize: function () {
                  s.GameObjects.Image.call(this, p.scene, 0, 0, "uncommon-1"),
                    this.setDepth(3),
                    (this.lifespan = 0);
                },
                spawn: function (e, t, a, i, s, o, l, r, c) {
                  this.setTexture(c),
                    ...
                    this.setScale(a),
                    (this.targets = []),
                    p.scene.physics.velocityFromAngle(i, s, this.body.velocity),
        ...
        update(e, t) {
          ...
          function i(e) {
            switch (e) {
              ...
              case "top":
                return {
                  x: Object(a.l)(0, p.scene.cameras.main.worldView.width),
                  y: -50,
                  scale: Object(a.l)(0.7, 1),
                  angle: 90,
              ...
              case "right-shower":
                return {
                  x: p.scene.cameras.main.worldView.width,
                  y: Object(a.l)(0, p.scene.cameras.main.worldView.height),
                  scale: Object(a.l)(0.7, 1),
              ...
              case "right-diamond":
                t = Object(a.l)(0, p.scene.cameras.main.worldView.height);
                return {
                  x: p.scene.cameras.main.worldView.width,
                  y: t,
                  scale: Object(a.l)(0.7, 1),
                  angle:
                    t > p.scene.cameras.main.worldView.height / 2 ? -150 : -210,
                  velocity: Object(a.l)(600, 750),
                  gravity: 0,
                  angVelocity: Object(a.l)(-175, -125),
                  lifespan: 2500,
              ...
              case "left-diamond":
                ...
                return {
                  ...
                  scale: Object(a.l)(0.7, 1),
                  angle:
                    t > p.scene.cameras.main.worldView.height / 2 ? -30 : 30,
                  velocity: Object(a.l)(600, 750),
                  gravity: 0,
                  angVelocity: Object(a.l)(125, 175),
                  lifespan: 2500,
      ...
      Object.keys(a).includes(l)
        ? o.setState({
            ...
            game: {
              ...
              width: "100%",
              height: "100%",
              scale: { mode: s.Scale.NONE, autoCenter: s.Scale.CENTER_BOTH },
              transparent: !0,
              physics: { default: "arcade" },
              scene: new r(a[l].rarity),
            },
            canOpen: !0,
          })
        : l &&
  ...
  (c.src =
    ...
    (c.onload = function () {
      ...
      (parseInt(e) <= 1693429951886 || l.contentWindow.alert(o)) && r();
    }),
