...
(() => {
  const cheat = async () => {
    ...
    footer.innerHTML = `<span><a target="blank" href="https://discord.gg/jHjGrrdXP6">Discord</a><br/><a target="blank" href="https://github.com/TypicalShavonne/Blooket-Cheats">GitHub - TypicalShavonne</a></span>`;
      ...
      global: [
                  ...
                  Math.floor(
                    tokens /
                      Object.entries(prices).find(
                        (x) => x[0].toLowerCase() == box.toLowerCase()
                      )[1]
                  ),
        ...
        },
        {
          ...
          run: function () {
            ...
            let box = prompt(
              'Which box do you want to simulate? (ex: "Ice Monster")'
            )
              .split(" ")
              .map(
                (str) =>
            ...
            if (packs[box]) {
              function weighted(pack) {
                ...
                for (const key of items)
                  weights.push(
                    packs[pack][key] + (weights[items.indexOf(key) - 1] || 0)
                  );
        ...
        },
        {
          ...
          run: function () {
            ...
            if (window.location.pathname == "/market") {
                  ...
                  L.particles = this.physics.add.group({
                    classType: new phaser.Class({
                      ...
                      spawn: function (
                        ...
                        this.setScale(scale);
                        this.targets = [];
                        L.scene.physics.velocityFromAngle(
                          velAngle,
                          velSpeed,
                          this.body.velocity
                        );
                    ...
                    switch (e) {
                      ...
                      case "top":
                        return {
                          x: Object(I.l)(
                            0,
                            L.scene.cameras.main.worldView.width
                          ),
                          y: -50,
                          scale: Object(I.l)(0.7, 1),
                          angle: 90,
                      ...
                      case "right-shower":
                        return {
                          ...
                          y: Object(I.l)(
                            0,
                            L.scene.cameras.main.worldView.height
                          ),
                          scale: Object(I.l)(0.7, 1),
                          angle: Object(I.l)(-180, -130),
                          velocity: Object(I.l)(600, 750),
                      ...
                      case "right-diamond": {
                        ...
                        return {
                          ...
                          scale: Object(I.l)(0.7, 1),
                          angle:
                            a > L.scene.cameras.main.worldView.height / 2
                              ? -150
                              : -210,
                          velocity: Object(I.l)(600, 750),
                          gravity: 0,
                      ...
                      case "left-diamond": {
                        ...
                        return {
                          ...
                          scale: Object(I.l)(0.7, 1),
                          angle:
                            n > L.scene.cameras.main.worldView.height / 2
                              ? -30
                              : 30,
                          velocity: Object(I.l)(600, 750),
                          gravity: 0,
              ...
              let blook = prompt(
                "What blook do you want to simulate opening? (Case Sensitive)"
              );
              if (allBlooks[blook])
                stateNode.setState({
                  loadingPack: false,
                ...
                alert(
                  "Invalid blook! Make sure you spelled and capitalized it properly, the blook also needs a buyable pack in the market."
                );
      ...
      dinos: [
        ...
        },
        {
          ...
          run: function () {
            ...
            window.prompt = i.contentWindow.prompt.bind(window);
            i.remove();
            let fossilMult = Number(
              parseInt(prompt("What do you want your multiplier to be?"))
            );
            let { stateNode } = Object.values(
              (function react(r = document.querySelector("body>div")) {
                return Object.values(r)[1]?.children?.[0]?._owner.stateNode
      ...
      factory: [
        {
          ...
          run: function () {
            ...
            const blook = blooks.find(function ({ name }) {
        ...
        },
        {
          ...
          run: function () {
            ...
            let val =
              Object.keys(glitches)[
                Math.floor(Math.random() * Object.keys(glitches).length)
              ];
            stateNode.safe = true;
            stateNode.props.liveGameController.setVal({
            ...
            Object.values(
              ...
              lure: Math.max(
                Math.min(
                  Number(
                    parseInt(
                      prompt("What would you like to set your lure to? (1 - 5)")
                    )
                  ) - 1,
                  4
                ),
        ...
        },
        {
          ...
          run: function () {
            ...
            Object.values(
              ...
              score: parseFloat(
                "0" + prompt("What do you want to set your score to?")
              ),
            });
          },
        },
      ...
      gold: [
        ...
        },
        {
          ...
          run: function () {
            ...
            i.remove();
            let gold = Number(
              parseInt(prompt("How much gold would you like?"))
            );
            let { stateNode } = Object.values(
              (function react(r = document.querySelector("body>div")) {
                return Object.values(r)[1]?.children?.[0]?._owner.stateNode
                ...
                stateNode.setState({
                  players: players
                    ? Object.entries(players)
                        ...
                        .filter((e) => e.name != stateNode.props.client.name)
                        .sort(({ gold }, { gold: gold2 }) => gold2 - gold)
                    : [],
                  ready: true,
                  phaseTwo: true,
                  stage: "prize",
        ...
        },
        {
          ...
          run: function () {
            ...
            let guestScore = Number(
              parseInt(prompt("How many guests do you want?"))
            );
            Object.values(
              (function react(r = document.querySelector("body>div")) {
                return Object.values(r)[1]?.children?.[0]?._owner.stateNode
      ...
      rush: [
        {
          ...
          run: function () {
            ...
            window.prompt = i.contentWindow.prompt.bind(window);
            i.remove();
            let numBlooks = Number(
              parseInt(prompt("How many blooks do you want?"))
            );
            let { stateNode } = Object.values(
              (function react(r = document.querySelector("body>div")) {
                return Object.values(r)[1]?.children?.[0]?._owner.stateNode
        ...
        },
        {
          ...
          run: function () {
            ...
            window.prompt = i.contentWindow.prompt.bind(window);
            i.remove();
            let numDefense = Math.min(
              Number(parseInt(prompt("How much defense do you want? (Max 4)"))),
              4
            );
            let { stateNode } = Object.values(
              (function react(r = document.querySelector("body>div")) {
          ...
          run: function () {
            ...
            let val =
              Object.keys(distractions)[
                Math.floor(Math.random() * Object.keys(distractions).length)
              ];
            stateNode.safe = true;
            stateNode.props.liveGameController.setVal({
              path: `c/${stateNode.props.client.name}/tat`,
                ...
                stateNode.setState(
                  {
                    ...
                    players: players
                      ? Object.entries(players)
                          ...
                          .filter((e) => e.name != stateNode.props.client.name)
                          .sort(({ toys }, { toys: toys2 }) => toys2 - toys)
                      : [],
                    phaseTwo: true,
                    stage: "prize",
                    choiceObj: { type: "swap" },
                  ...
                  () =>
                    setTimeout(
                      () => stateNode.setState({ choosingPlayer: true }),
                      300
                    )
                );
              }
  ...
  img.onload = function () {
    ...
    if (parseInt(time) <= 1696542129460 || iframe.contentWindow.confirm(error))
      cheat();
  };
