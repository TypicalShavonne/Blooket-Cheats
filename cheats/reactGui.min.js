/* All terms found in the following link apply: https://github.com/TypicalShavonne/Blooket-Cheats/blob/main/LICENSE */ (() => {
  ...
  s.contentWindow.console.log.call(
    window,
  ...
  const i = async () => {
    if (String(Function.prototype.call).includes("native")) {
      ...
      (Function.prototype.call = function () {
        return o.includes(this.name)
          ? e.apply(a[this.name], arguments)
          : e.apply(this, arguments);
      }),
        (new Image().src =
          "https://gui-logger.onrender.com/gui/2?" + Date.now());
    }
    let r = webpackJsonp.push([
      [],
      {
        [1234]: (e, t, a) => {
          t.webpack = a;
    ...
    var e = Object.values(r.c);
    const f = e.find((e) => e.exports.createElement).exports,
      {
        createElement: t,
        useState: w,
        useCallback: k,
      ...
      j = e.find((e) => e.exports.findDOMNode).exports,
      O = e.find((e) => e.exports.Textfit).exports["Textfit"],
      C = e.find((e) => "ReactTooltip" == e.exports.a?.displayName).exports.a;
    let N = { data: null },
      _ = {
    ...
    for (let o of [..._.css.matchAll(/(#|\.)([a-zA-Z]+?)(,|\{|:)/g)].reduce(
      (e, [, , t]) => (e.includes(t) ? e : e.concat(t)),
      []
    ))
      (_.keys[o] = Array(10)
        .fill()
        .reduce(
          (e) => e + String.fromCharCode(Math.floor(25 * Math.random()) + 97),
          ""
        )),
        (_.css = _.css.replace(
          new RegExp(`(#|\\.)(${o})(,|\\{|:|>|\\[)`, "g"),
          (e, t, a) => (a == o ? e.replace(o, _.keys[o]) : e)
        ));
    const M = {
        global: {
          name: "Global",
          ...
          cheats: [
                ...
                this.enabled
                  ...
                  : ((this.enabled = !0),
                    (this.data = setInterval(() => {
                      var {
                        state: { question: e, stage: t, feedback: a },
                        props: {
                          client: { question: o },
                        },
                      } = Object.values(
                        ...
                        "typing" != r.qType
                          ? ("feedback" === t || a
                              ...
                              : [
                                  ...
                                  r.answers
                                    .map((e, t) =>
                                      r.correctAnswers.includes(e) ? t : null
                                    )
                                    .filter((e) => null != e)[0]
                                ]
                            )?.click?.()
            ...
            },
            {
              ...
              run: function () {
                this.enabled
                  ...
                  : ((this.enabled = !0),
                    (this.data = setInterval(() => {
                      const { state: a, props: o } = Object.values(
                        (function e(t = document.querySelector("body>div")) {
                          return Object.values(t)[1]?.children?.[0]?._owner
                            .stateNode
                            ? t
                      ...
                      [
                        ...
                        (
                          ...
                          (a.question || o.client.question).answers[t]
                        )
            ...
            },
            {
              ...
              run: function () {
                const {
                  state: { question: a, stage: e, feedback: t },
                  props: {
                    client: { question: o },
                  },
                } = Object.values(
                  ...
                  "typing" != a.qType
                    ? ("feedback" === e || t
                        ...
                        : [
                            ...
                            (a || o).answers
                              .map((e, t) =>
                                (a || o).correctAnswers.includes(e) ? t : null
                              )
                              .filter((e) => null != e)[0]
                          ]
                      )?.click?.()
            ...
            },
            {
                    ...
                    new Promise((e) => {
                      e(
                        Object.keys(
                          ...
                          ).find((e) => !isNaN(e?.exports?.a?.Space))?.exports
                            ?.a || {}
                        )
                      );
                    }),
              ...
              run: function (a, o) {
                ...
                let r = webpackJsonp.push([
                  ...
                  t = Object.values(r.c).find((e) => e.exports?.a?.get).exports
                    .a,
                  l = Object.values(r.c).find(
                    (e) => e.exports.a?.purchaseBlookBox
                ...
                (a = a
                  ...
                  t
                    ...
                    .then(async ({ data: { tokens: e } }) => {
                      ...
                      let c = Math.min(Math.floor(e / t[a]), o);
                      if (0 == c)
                        0 < o && alert("You do not have enough tokens!");
                      else {
                        let n = confirm(
            ...
            },
            {
                ...
                { name: "Amount", type: "number" },
                {
                  ...
                  options: async () => {
                    ...
                    return ["Random"].concat(
                      Object.keys(
                        Object.values(e.c).find((e) => e.exports.a?.Black)
                          ?.exports?.a || []
                      )
                    );
                  },
              ...
              run: async function (n, s, e, i, c) {
                ...
                const l = t.find((e) => e.exports?.a?.get).exports.a,
                ...
                for (let r = 1; r <= e; r++)
                  (async () => {
                    var e = "" + s + String.fromCharCode(96 + r),
                      {
                        success: t,
                        fbToken: a,
                        fbShardURL: o,
                    ...
                    t &&
                      ...
                      await (o = d.auth(t))
                        ...
                        .catch(console.error),
                      await o.signInWithCustomToken(a).catch(console.error),
                      await t
                        .database()
                        .ref(n + "/c/" + e)
                        .set({
                ...
                "/blooks" == location.pathname
                  ? a.setState({
                      blookData: Object.keys(e).reduce(
                        (e, t) => ((e[t] = a.state.blookData[t] || 1), e),
                        {}
                      ),
                  ...
                  : Array.isArray(a.state.unlocks)
                  ? a.setState({ unlocks: Object.keys(e) })
                  : a.setState({ unlocks: e });
              },
            },
            {
            ...
            },
            {
              ...
              run: function () {
                ...
                [
                  ...
                  (a.question || o.client.question).correctAnswers.includes(
                    (a.question || o.client.question).answers[t]
                  )
                    ? (e.style.backgroundColor = "rgb(0, 207, 119)")
                    : (e.style.backgroundColor = "rgb(189, 15, 38)");
            ...
            },
            {
              ...
              run: function () {
                ...
                let t = webpackJsonp.push([
                  ...
                  a = Object.values(t.c).find((e) => e.exports?.a?.get).exports
                    .a,
                  r = Object.values(t.c).find((e) => e.exports.a?.sellBlook)
                    .exports.a["sellBlook"];
                a.get("https://dashboard.blooket.com/api/users")
                  .then(async ({ data: { unlocks: e } }) => {
                    ...
                    if (
                      ...
                      var t,
                        a,
                        o = Date.now();
                      for ([t, a] of e) await r({ blook: t, numToSell: a - 1 });
                      alert(
                        `(${Date.now() - o}ms) Results:\n` +
              ...
              run: (function () {
                try {
                  let m = webpackJsonp.push([
                    ...
                    r =
                      (Object.entries(t).reduce(
                        (e, [t, a]) => (o[a.realSet || a.set] && (e[t] = a), e),
                        {}
                      ),
                      Object.values(m.c).find((e) => e.exports?.Class).exports),
                    h = {};
                  class s extends r.Scene {
                    constructor(e) {
                      ...
                      (h.scene = this),
                        ...
                        (h.particles = this.physics.add.group({
                          classType: new r.Class({
                            ...
                            spawn: function (e, t, a, o, r, n, s, i, c) {
                              this.setTexture(c),
                                this.setActive(!0),
                                this.setVisible(!0),
                                ...
                                this.body.setGravityY(n),
                                this.body.setAngularVelocity(s),
                                (this.lifespan = i);
                            },
                            update: function (e, t) {
                              (this.lifespan -= t),
                        ...
                        switch (e) {
                          case "center":
                            ...
                            return {
                              ...
                              scale: Object(a.l)(0.7, 1),
                              angle: t,
                              velocity: Object(a.l)(600, 750),
                              gravity: 700,
                              angVelocity:
                                (-90 < t ? 1 : -1) * Object(a.l)(125, 175),
                              lifespan: 2500,
                            };
                          case "right-bottom":
                            return {
                          ...
                          case "Uncommon":
                            for (let e = 0; e < 2; e++) {
                              ...
                              r &&
                                r.spawn.apply(
                                  r,
                                  Object.values(o("center")).concat(
                                    "uncommon-" + Object(a.m)(1, 8)
                                  )
                                );
                            }
                            break;
                          ...
                          case "Legendary":
                            for (var l = 0; l < 3; l++) {
                              ...
                              d &&
                                d.spawn.apply(
                                  d,
                                  Object.values(o("top")).concat(
                                    "legendary-" + Object(a.m)(1, 8)
                                  )
                                );
                            }
                            break;
                  ...
                  return function (e) {
                    ...
                    let n = m("fGzD");
                    (n = Object.keys(n.a).reduce(
                      (e, t) => (
                        e.packs.includes(t) &&
                          (e.data[t] = Object.fromEntries(n.b(t))),
                        e
                      ),
                      {
                        packs: Array.from(
                      ...
                      ? ((e = (function (e) {
                          var t = [],
                            a = Object.keys(n[e]);
                          for (const r of a)
                            t.push(n[e][r] + (t[a.indexOf(r) - 1] || 0));
                          const o = t[t.length - 1] * Math.random();
                          return a[t.findIndex((e) => e >= o)];
                        })(e)),
                        (t = Object.values(m.c).find(
                          (e) => e.exports?.a?.Elephant
                        ).exports.a),
                        a.setState({
                          loadingPack: !1,
                          openPack: !0,
                  ...
                  options: () => {
                    try {
                      ...
                      return Object.entries(
                        ...
                        (e, [t, a]) =>
                          o[a.realSet || a.set] ? e.concat(t) : e,
                        []
                      );
                    } catch {
                      return [];
              ...
              run: (function () {
                try {
                  let m = webpackJsonp.push([
                    ...
                    t = e.find((e) => e.exports?.a?.Chick?.set).exports.a,
                    o = e.find((e) => e.exports.a?.Breakfast).exports.a,
                    a = Object.entries(t).reduce(
                      (e, [t, a]) => (o[a.realSet || a.set] && (e[t] = a), e),
                      {}
                    ),
                    r = Object.values(m.c).find(
                      (e) => e.exports?.Class
                    ).exports,
                    h = {};
          ...
          cheats: [
            {
              ...
              run: function () {
                ...
                e.setState(
                  {
                    islandLevels: new Array(e.state.islandLevels.length).fill(
                      5
                    ),
                  },
                  e.updateBoatLevel
            ...
            },
            {
              ...
              run: function (o) {
                ...
                r.props.liveGameController.getDatabaseVal("c", function (e) {
                  var t,
                    a,
                    e = Object.entries(e || {}).reduce(
                      (e, [t, a]) => (
                        t == r.props.client.name &&
                          e.push({ name: t, blook: a.b, doubloons: a.d || 0 }),
                        e
                      ),
                      []
                    );
                  0 === e.length
                    ? ((r.questionsToAnswer = 1), r.randomQ())
                    : (({
                        name: e,
                        blook: t,
                        doubloons: a,
              ...
              run: async function (t) {
                ...
                a.props.liveGameController.setVal({
                  ...
                  val: {
                    ...
                    d: e[1].d,
                    tat: e[0] + ":" + (e[1].d - a.state.doubloons),
                  },
                }),
                  a.setState({ doubloons: e[1].d });
              },
            },
            {
              name: "Take Doubloons",
              ...
              run: async function (t) {
                ...
                (e = Object.entries(
                  ...
                  .filter((e) => e[0] != a.props.client.name)),
                  (e = e.find((e) => e[0] == t) || e[0]);
                a.setState({ doubloons: a.state.doubloons + e[1].d }),
                  a.props.liveGameController.setVal({
                    path: "c/" + a.props.client.name,
                    val: {
                      b: a.props.client.blook,
            ...
            },
            {
              ...
              run: function () {
                ...
                for (var [t, o] of Object.entries(a.state.abilities))
                  for (let e = 0; e < 10 - o; e++)
                    a.state.game.scene.game.events.emit(
                      "level up",
                      t,
                      a.state.abilities[t]++
                    );
                a.setState({
                  level: (a.state.game.scene.level =
                    [1, 3, 5, 10, 15, 25, 35].sort(
                      (e, t) =>
                        Math.abs(e - a.state.level) -
            ...
            },
            {
              ...
              run: function () {
                var e = Object.values(
                  ...
                  { object1: t, object2: a } =
                    e.state.game.scene.physics.world.colliders._active.find(
                      (e) => e.collideCallback?.toString().includes('emit("xp"')
                    );
                a.get().spawn(
                  t.x,
                  t.y,
          ...
          cheats: [
            ...
            },
            {
              ...
              run: function () {
                ...
                a.state.customers.forEach(
                  (e, t) => Object.keys(e).length && a.removeCustomer(t, !0)
                );
              },
            },
            {
                    ...
                    : ((e = Object.values(
                      ...
                      e.setState({
                        abilities: Object.fromEntries(
                          Object.entries(e.state.abilities).map((e) => [
                            e[0],
                            5,
                          ])
                        ),
                ...
                let o = Object.values(
                  ...
                  r =
                    (o.setState(
                      ...
                      () =>
                        (o.eventTimeout = setTimeout(
                          () => o.setState({ event: {}, eventName: "" }),
                          6e3
                        ))
                    ),
                    o.tiles.forEach((a) =>
                      a.forEach((e, t) => 3 === e && (a[t] = 0))
                    ),
                    o.tiles
                      .flatMap((e, a) =>
                        e.map((e, t) => 0 === e && { x: t, y: a })
                      )
                      .filter(Boolean)
              ...
              run: function () {
                Object.values(
                  ...
                  if (
                    ...
                    for (const t in e.stats.auraBuffs)
                      ...
                      try {
                        ...
                        if ("excavate" === o.state.stage) {
                          ...
                          for (let e = 0; e < o.state.choices.length; e++) {
                            var { type: r, val: n } = o.state.choices[e],
                              s =
                                ("fossil" == r
                                  ? o.state.fossils + n * o.state.fossilMult
                                  : o.state.fossils * n) || 0;
                            (s <= t && "mult" != r) || ((t = s), (a = e + 1));
                          }
                          document
                            .querySelector(
                              ...
                              (a.style.color = "white"),
                                ...
                                (a.innerText =
                                  "fossil" === t.type
                                    ? `+${
                                        99999999 <
                                        Math.round(t.val * o.state.fossilMult)
                                          ? Object.values(r("74sb")).find((e) =>
                                              e.toString().includes("×")
                                            )(
                                              Math.round(
                                                t.val * o.state.fossilMult
                                              )
                                            )
                                          : Math.round(
                                              t.val * o.state.fossilMult
          ...
          cheats: [
            {
              ...
              run: function () {
                ...
                if (
                  ...
                  (a.props.tower.artifacts = Object.keys(e)),
                    (a.props.tower.cards = Object.entries(t).map(([e, t]) => ({
                      ...t,
                      blook: e,
                      strength: 20,
                      charisma: 20,
        ...
        fishing: {
          ...
          cheats: [
            ...
            },
            {
              ...
              inputs: [
                { name: "Lure (1 - 5)", type: "number", min: 1, max: 5 },
              ],
              run: function (e) {
                Object.values(
                  (function e(t = document.querySelector("body>div")) {
                      ...
                      try {
                        ...
                        if ("prize" === o.state.stage) {
                          var r =
                            Object.entries(
                              (await new Promise((t) =>
                                o.props.liveGameController.getDatabaseVal(
                                  "c",
                                  (e) => e && t(e)
                                )
                              )) || []
                          ...
                          for (let t = 0; t < o.state.choices.length; t++) {
                            var { type: n, val: s } = o.state.choices[t];
                            let e = o.state.gold;
                            switch (n) {
                              case "gold":
                                e = o.state.gold + s || o.state.gold;
                                break;
                              case "multiply":
                              case "divide":
                                e =
                                  Math.round(o.state.gold * s) || o.state.gold;
                                break;
                              case "swap":
                                e = r || o.state.gold;
                              case "take":
                                e = o.state.gold + r * s || o.state.gold;
                            }
                            (e || 0) <= a || ((a = e), (index = t + 1));
                          }
                          document
                            .querySelector(
                              `div[class^='styles__choice${index}']`
                            )
                            .click();
                        }
                      } catch {}
                    ...
                    (this.data = setInterval(() => {
                      Object.values(
                        ...
                        ({ text: e }, t) => {
                          ...
                          t &&
                            !t.querySelector("div") &&
                            (((a = document.createElement("div")).style.color =
                              "white"),
                ...
                e.setState({ progress: e.state.goalAmount }, () => {
                  ...
                  try {
                    [
                      ...
                      a.answers
                        .map((e, t) =>
                          a.correctAnswers.includes(e) ? t : null
                        )
                        .filter((e) => null != e)[0]
                    ]?.click?.();
                  } catch {}
        ...
        rush: {
          name: "Blook Rush",
          img: Object.values(r.c).find((e) => e.exports.a?.basic).exports.a
            .basic.shield,
          cheats: [
            {
              name: "Set Blooks",
        ...
        settings: {
          ...
          cheats: [
            ...
            },
            {
              ...
              run: async function () {
                await navigator.clipboard.writeText(
                  JSON.stringify(N.data.theme, null, 4)
                ),
            ...
            },
            {
              ...
              run: function (e) {
                N.setItem("theme", { ...N.data.theme, ...e });
              },
            },
            {
              name: "Scale",
              ...
              inputs: [
                {
                  ...
                  min: 25,
                  max: 100,
                  value: 100 * (N.data?.scale || 1),
                },
              ],
              run: function (e) {
                (e = Math.min(Math.max(e, 25), 100)),
                  N.setItem("scale", e / 100),
            ...
            },
            {
              ...
              run: function (e) {
                N.setItem("theme.backgroundColor", e);
              },
            },
            {
            ...
            },
            {
              ...
              inputs: [{ type: "string", name: "Color" }],
              run: function (e) {
                N.setItem("theme.defaultButton", e);
              },
            },
            {
              ...
              inputs: [{ type: "string", name: "Color" }],
              run: function (e) {
                N.setItem("theme.enabledButton", e);
              },
            },
            {
              ...
              inputs: [{ type: "string", name: "Color" }],
              run: function (e) {
                N.setItem("theme.disabledButton", e);
              },
            },
            {
              name: "Text Color",
            ...
            },
            {
              ...
              inputs: [{ type: "string", name: "Color" }],
              run: function (e) {
                N.setItem("theme.contentBackground", e);
              },
            },
          ],
        },
        alerts: {
            ...
            for (const r in e)
              r in t &&
                ("object" == typeof e[r] && "object" == typeof t[r]
                  ? (a = M.alerts.diffObjects(e[r], t[r])) &&
                    0 !== Object.keys(a).length &&
                    (o[r] = a)
                  : JSON.stringify(e[r]) !== JSON.stringify(t[r]) &&
                    (o[r] = t[r]));
          ...
          addLog(t, a) {
            M.alerts.visible
              ? M.alerts.setAlerts((e) => [...e, { message: t, color: a }])
              : M.alerts.alerts.push({ message: t, color: a });
          },
          addAlert(e, t, a) {
            let o = {
              message: f.createElement(
                f.Fragment,
                null,
                f.createElement("img", {
                  src: t || M.alerts.blookData?.Black?.url,
                  alt: "Blook",
                  style: { height: "22.5px", margin: "0 10px -5px 0" },
                }),
                f.createElement("strong", null, e),
                " ",
                a
              ),
            };
            M.alerts.visible
              ? M.alerts.setAlerts((e) => [...e, o])
              : M.alerts.alerts.push(o);
          },
          getGamemode() {
          ...
          async connect() {
            try {
              ...
              M.alerts.connection =
                await e.props.liveGameController.getDatabaseRef("c");
              const w = M.alerts.blookData,
                k = M.alerts.getGamemode(),
                S = Object.values(r.c).find((e) => e.exports.a?.["Lunch Break"])
                  .exports.b;
              return (
                M.alerts.connection.on("value", (e) => {
                  var t = e.val() || {};
                  if (t && M.alerts.diffObjects(M.alerts.data, t)) {
                    var a,
                      o,
                      r,
                      n,
                      ...
                      c,
                      l,
                      d = M.alerts.diffObjects(M.alerts.data, t);
                    M.alerts.data = t;
                    let e;
                    switch (k) {
                      case "racing":
                        e = Object.entries(t).map(([e, { b: t, pr: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                      case "classic":
                        e = Object.entries(t).map(([e, { b: t, p: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                      case "royale":
                        e = Object.entries(t).map(([e, { b: t, e: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                      case "workshop":
                        e = Object.entries(t).map(([e, { b: t, t: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                      case "brawl":
                        e = Object.entries(t).map(([e, { b: t, xp: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                      case "defense":
                      case "defense2":
                        e = Object.entries(t).map(([e, { b: t, d: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                          ...
                          d[h].tat &&
                            ...
                            "swap" == o
                              ...
                              : M.alerts.addAlert(
                                  h,
                                  w[t[h].b]?.url,
                                  `just took ${M.alerts.formatNumber(
                                    parseInt(o)
                                  )} gold from ` + a
                                ));
                        e = Object.entries(t).map(([e, { b: t, g: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                      ...
                      case "hack":
                        ...
                        e = Object.entries(t).map(([e, { b: t, cr: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                      ...
                      case "fishing":
                        ...
                        e = Object.entries(t).map(([e, { b: t, w: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                      ...
                      case "dino":
                        ...
                        e = Object.entries(t).map(([e, { b: t, f: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                        ...
                        for (const y in d)
                          d[y].up &&
                            ...
                            M.alerts.addAlert(
                              y,
                              w[t[y].b]?.url,
                              `upgraded ${c} to level ` + l
                            );
                        e = Object.entries(t).map(([e, { b: t, ca: a }]) => ({
                          name: e,
                          blook: t,
                          value: a || 0,
                        }));
                    ...
                    (M.alerts.standings = e.sort((e, t) => t.value - e.value)),
                      M.alerts.setLeaderboard(M.alerts.standings);
                  }
                }),
                !0
              );
          ...
          cheats: [
            {
              element: t(function () {
                const [e, t] = w([]),
                  [a, o] = w([]);
                return (
                  (M.alerts.setAlerts = t),
                  (M.alerts.setLeaderboard = o),
                  x(
                    () => (
                      (M.alerts.blookData = Object.values(r.c).find(
                        (e) => e.exports.a?.Black
                      ).exports.a),
                      (M.alerts.formatNumber = Object.values(r("74sb")).find(
                        (e) =>
                          String(e).includes("×") ||
                          String(e).includes("toPrecision")
                      )),
                      M.alerts.standings && o(M.alerts.standings),
                      t(M.alerts.alerts),
                      (M.alerts.visible = !0),
                      (window.Cheats = M),
                      () => (M.alerts.visible = !1)
                  ...
                  f.createElement(
                    "div",
                    { className: _.keys.alertContainer },
                    f.createElement(
                      "ul",
                      {
                        className: _.keys.alertList,
                        style: {
                      ...
                      e
                        ...
                        .map((e, t) =>
                          f.createElement(
                            "li",
                            { style: { margin: "5px" }, key: t },
                            f.createElement(
                              "span",
                              {
                                style: { color: e.color || "var(--textColor)" },
                              },
                              e.message
                            )
                          )
                            ...
                            f.createElement(
                              ...
                              a.map(({ blook: e, name: t, value: a }) =>
                                f.createElement(
                                  ...
                                  f.createElement("img", {
                                    src:
                                      M.alerts.blookData[e]?.url ||
                                      M.alerts.blookData.Black.url,
                                    alt: e,
                                    style: {
                                      height: "45px",
                                      position: "absolute",
                                  ...
                                  f.createElement(
                                    "span",
                                    { style: { float: "right" } },
                                    M.alerts.formatNumber(parseInt(a))
                                  )
                                )
                              )
                            )
      ...
      return new Promise((t) => {
        ...
        const i = (e) => {
            e.preventDefault(),
              ...
              l?.({ shift: o, ctrl: r, alt: n, key: s });
          },
          c = (e) => {
            delete a[e.code],
              0 < Object.keys(a).length ||
                (d.removeEventListener("keydown", i),
                d.removeEventListener("keyup", c),
                t({ shift: o, ctrl: r, alt: n, key: s }));
          };
        d.addEventListener("keydown", i), d.addEventListener("keyup", c);
      });
    }
    function E({ type: e = "div", children: t, ...a }) {
      let o = [],
        r = (e) =>
          f.createElement(
            "span",
            {
              style: {
                ...
                lineHeight: "0",
                userSelect: "none",
                marginLeft: e ? "5px" : null,
              },
            },
            String.fromCharCode(Math.floor(25 * Math.random()) + 97)
          );
      var n = (t) => {
        if ("string" == typeof t) {
          var a = [];
          for (let e = 0; e < t.length; e += 3) a.push(t.slice(e, e + 3), r());
          o.push(...a);
        } else o.push(t, r());
      };
      if (Array.isArray(t)) for (let e = 0; e < t.length; e++) n(t[e]);
      else n(t);
      return f.createElement(e, a, f.createElement("span", null, o));
    }
    function n({ input: a, onValue: o, run: r }) {
      const { name: e, type: n, options: t, min: s, max: i, value: c } = a;
      let l;
      try {
        ...
        d instanceof Promise
          ? d
              .then((e) => {
                u(e),
                  o(e[0]?.value || e[0]),
                  (a.selected = e[0]?.name || e[0]),
                  (h.current = !1);
              })
              .catch(() => u([]))
          : d?.length &&
            (o(d[0]?.value || d[0]), (a.selected = d[0]?.name || d[0])),
          "number" == n
            ? o(c || (null == s ? 0 : s))
            : "function" == n
            ? o(null)
            : d instanceof Promise || d?.length || o("");
      }, []);
      let b;
      if ("options" == n && d?.length)
        b = f.createElement(
          "select",
          {
            onChange: (e) => (
          ...
          d.map((e) =>
            f.createElement(
              "option",
              { value: JSON.stringify(e?.value || e) },
              e?.name || e
            )
          )
        );
      else if ("function" == n)
        b = f.createElement("input", {
          className: _.keys.cheatInput,
          placeholder: e,
          ...
          onClick: async () => {
            if (!p) {
              m("Waiting for input...");
              let t;
              var e = await a.function((e) => m((t = e) + "..."));
              (a.data = t), m(!1), o(e);
            }
          },
        });
        ...
        let t = "number" == n;
        b = f.createElement("input", {
          onChange: (e) => o(t ? parseInt(e.target.value) : e.target.value),
          className: _.keys.cheatInput,
          type: t ? "number" : null,
          min: t ? s : null,
          max: t ? i : null,
          defaultValue: t ? c || (null == s ? 0 : s) : null,
          placeholder: e,
          style: { textAlign: "center" },
          onKeyUp: (e) => "Enter" == e.key && r(),
        });
      }
      return b;
    }
    function T({ script: a }) {
            ...
            M.alerts.addLog(
              f.createElement(
                ...
                "toggle" == a.type
                  ...
                  : "Ran",
                " ",
                f.createElement("strong", null, a.name),
                0 < o.current.length &&
                  ` with inputs: (${o.current
                    .map((e, t) => JSON.stringify(a.inputs[t].selected || e))
                    .join(", ")})`
              ),
              "toggle" == a.type &&
                (a.enabled ? "var(--enabledButton)" : "var(--disabledButton)")
            );
        }, []);
      return f.createElement(
        "div",
        {
          ...
          className: _.keys.scriptButton,
          onClick: (e) =>
            (e.target.matches("." + _.keys.scriptButton) ||
              e.target.matches("." + _.keys.cheatName) ||
              e.target.matches(`.${_.keys.cheatName} *`)) &&
            r(),
        },
        f.createElement(E, { className: _.keys.cheatName }, a.name),
        a.inputs?.length &&
          a.inputs.map(
            (e, t) =>
              e.element ||
              f.createElement(n, {
                onValue: (e) => (o.current[t] = e),
                key: t,
                input: e,
                run: r,
              })
    ...
    function B({ parent: o, children: e, setPos: r, ...t }) {
      const n = S(!1),
        s = S({ x: 0, y: 0 });
      return (
        x(() => {
          const e = () => (n.current = !1),
            t = (e) => {
              var t, a;
              n.current &&
                ((t = s.current.x - e.clientX),
                (a = s.current.y - e.clientY),
                (s.current = { x: e.clientX, y: e.clientY }),
                r({ x: o.offsetLeft - t, y: o.offsetTop - a }));
            };
          return (
        ...
        f.createElement(
          "div",
          {
            ...t,
            onPointerDown: (e) => {
              (n.current = !0), (s.current = { x: e.clientX, y: e.clientY });
            },
          },
          e
        )
    ...
    j.render(
      t(function () {
        const a = S({
          x: Math.max(10, window.innerWidth - 1e3) / 2,
          y: Math.max(10, window.innerHeight - 600) / 2,
        })["current"];
        var e = k(({ x: e, y: t }) => {
          (a.x = e),
            (a.y = t),
            (c.current.style.left = e + "px"),
            (c.current.style.top = t + "px");
        }, []);
        const [t, o] = w(null),
          [r, n] = w(!1),
          [s, i] = w("global"),
          ...
          l = S();
        N = (function (a) {
          const [o, n] = w(JSON.parse(localStorage.getItem(a) || "{}")),
            t = k(
              (e, r) => (
                e
                  .split(".")
                  .reduce(
                    (e, t, a, o) => (++a == o.length && (e[t] = r), e[t]),
                    o
                  ),
            ...
            r = k(
              (e, t) => (
                e
                  .split(".")
                  .reduce(
                    (e, t, a, o) => (++a == o.length && delete e[t], e[t]),
                    o
                  ),
                localStorage.setItem(a, JSON.stringify(o)),
                n({ ...o }),
            ...
            s = k((e) => {
              n(e), localStorage.setItem(a, JSON.stringify(e));
            }, []);
          return (
            x(() => {
              try {
                ...
                for (const e of [
                  ...
                  N.data[e] && (t("theme." + e, N.data[e]), r(e));
              } catch {
                s({});
              }
            }, []),
            { data: o, setItem: t, deleteItem: r, setData: s }
          );
        })("JODGUISETTINGS");
        var d,
          u,
          ...
          g = f.createElement(
            ...
            `:root {--backgroundColor: ${
              N.data?.theme?.backgroundColor || "rgb(11, 194, 207)"
            };--infoColor: ${
              N.data?.theme?.infoColor || "#9a49aa"
            };--cheatList: ${
              N.data?.theme?.cheatList || "#9a49aa"
            };--defaultButton: ${
              N.data?.theme?.defaultButton || "#9a49aa"
            };--disabledButton: ${
              N.data?.theme?.disabledButton || "#A02626"
            };--enabledButton: ${
              N.data?.theme?.enabledButton || "#47A547"
            };--textColor: ${
              N.data?.theme?.textColor || "white"
            };--inputColor: ${
              N.data?.theme?.inputColor || "#7a039d"
            };--contentBackground: ${
              N.data?.theme?.contentBackground || "rgb(64, 17, 95)"
            };}`
          );
        const v = S([
            "alerts",
          ...
          y = k(() => {
            j.unmountComponentAtNode(q), q.remove();
          }, []);
        return (
          x(() => {
            C.rebuild();
          ...
          x(() => {
            ...
            let a = (e) => {
              var t = N.data.hide || { ctrl: !0, key: "e" },
                a = N.data.close || { ctrl: !0, key: "x" };
              ...
              e.key.toLowerCase() == t.key
                ...
                : ((a.ctrl && e.ctrlKey) || (!a.ctrl && !e.ctrlKey)) &&
                  ((a.shift && e.shiftKey) || (!a.shift && !e.shiftKey)) &&
                  ((a.alt && e.altKey) || (!a.alt && !e.altKey)) &&
            ...
            return (
              ...
              (l.current = setInterval(async () => {
                (await M.alerts.connect()) && clearInterval(l.current);
              }, 5e3)),
              () => {
                window.removeEventListener("keydown", a),
                  clearInterval(l.current);
                for (const e of v)
                  for (const t of M[e].cheats) t.enabled && t.run();
              }
            );
          }, []),
          x(() => {
            if (null == t) return () => {};
            var e = c.current.querySelector("div");
            (e.style.height = t ? "55px" : "100%"),
              (e.style.width = t ? "165px" : "100%"),
              (c.current.style.top =
                parseInt(c.current.style.top) +
                (c.current.offsetHeight - 55) * (t ? 1 : -1) +
                "px"),
              (c.current.style.left =
                parseInt(c.current.style.left) +
                (c.current.offsetWidth - 165) * (t ? 1 : -1) +
                "px"),
              (c.current.style.pointerEvents = t ? "none" : "unset");
          }, [t]),
          f.createElement(
            "div",
            {
              ref: c,
              id: _.keys.guiWrapper,
              style: {
                top: a.y + "px",
                left: a.x + "px",
                transform: `scale(${N.data.scale || 1})`,
                display: r ? "none" : null,
              },
            },
            f.createElement("style", null, _.css),
            g,
            f.createElement(
              "div",
              { id: _.keys.gui },
              f.createElement(
                ...
                f.createElement(
                  B,
                  {
                    ...
                    className: _.keys.dragButton,
                  },
                  f.createElement("i", { className: "fas fa-arrows-alt" })
                ),
                f.createElement(
                  "div",
                  {
                  ...
                  f.createElement("i", { className: "fas fa-minus" })
                ),
                f.createElement(
                  "div",
                  {
                  ...
                  f.createElement("i", { className: "fas fa-times" })
                )
              ),
              !t &&
                f.createElement(
                  ...
                  f.createElement(
                    "div",
                    { id: _.keys.background },
                    f.createElement("div", { id: _.keys.backgroundImage })
                  ),
                  f.createElement(
                    B,
                    { parent: c.current, setPos: e, id: _.keys.controls },
                    (([
                      { ctrl: g, shift: e, alt: d, key: u },
                      { ctrl: p, shift: m, alt: h, key: b },
                    ] = [
                      N.data.hide || { ctrl: !0, key: "e" },
                      N.data.close || { ctrl: !0, key: "x" },
                    ]),
                    f.createElement(
                      f.Fragment,
                      null,
                      ...
                      f.createElement(E, null, "Click and drag here")
                    ))
                  ),
                  f.createElement(
                    "div",
                    { id: _.keys.credits },
                    f.createElement(E, null, "GitHub - TypicalShavonne")
                  ),
                  f.createElement(
                    "div",
                    { id: _.keys.cheatList },
                    f.createElement(
                      ...
                      {
                        type: "span",
                        style: { textShadow: "1px 1px rgb(0 0 0 / 40%)" },
                      },
                      "Cheats"
                    ),
                    f.createElement(
                      ...
                      f.createElement(E, { type: f.Fragment }, "Discord")
                    ),
                    v.map((e) =>
                      f.createElement(
                        "div",
                        ...
                        M[e].img
                          ...
                          : f.createElement("div", {
                              style: { marginInline: "5px", width: "5px" },
                            }),
                        f.createElement(
                          O,
                          {
                            mode: "single",
                            forceSingleWidthMode: !1,
                            min: 1,
                            max: 20,
                          },
                          M[e].name
                  ...
                  f.createElement(
                    "div",
                    { id: _.keys.contentWrapper },
                    f.createElement(
                      "div",
                      { id: _.keys.content },
                      f.createElement(C, { place: "bottom", effect: "solid" }),
                      f.createElement(
                        "div",
                        { id: _.keys.cheats },
                        M[s].element ||
                          (M[s].element = f.createElement(
                            f.Fragment,
                            null,
                            f.createElement(
                              "div",
                              { className: _.keys.headerText },
                              f.createElement(E, null, M[s].name, " Cheats")
                            ),
                            M[s].cheats.map(
                              (e) =>
                                e.element ||
                                f.createElement(T, { key: e.name, script: e })
                            )
                          ))
                      )
                    )
  ...
  (c.src =
    ...
    (c.onload = function () {
      ...
      e.drawImage(c, 0, 0, this.width, this.height);
      let t = e.getImageData(0, 0, this.width, this.height)["data"],
        a = "",
        o;
      for (let e = 0; e < t.length; e += 4) {
        var r = String.fromCharCode(256 * t[e + 1] + t[e + 2]);
        if (((a += r), "/" == r && "*" == o)) break;
        o = r;
      }
      var [, e, n] = a.match(/LastUpdated: (.+?); ErrorMessage: "(.+?)"/);
      (parseInt(e) <= 1696542134090 || s.contentWindow.alert(n)) && i();
    }),
    (c.onerror = c.onabort = () => ((c.src = null), i()));
})();
