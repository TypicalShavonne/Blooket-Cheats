/* All terms found in the following link apply: https://github.com/TypicalShavonne/Blooket-Cheats/blob/main/LICENSE */ (() => {
  let m = document.querySelector("iframe");
  m.contentWindow.console.log.call(
    window,
  ...
  const t = async () => {
    var e = document.createElement("iframe"),
      e =
        ...
        e.remove(),
        Object.values(
          (function e(a = document.querySelector("body>div")) {
            return Object.values(a)[1]?.children?.[0]?._owner.stateNode
              ? a
              : e(a.querySelector(":scope>div"));
          })()
    ...
    a
      ? (10 <= e.state.blooks.length && alert("Choose a blook to replace"),
        e.chooseBlook(a))
  ...
  (s.src =
    ...
    (s.onload = function () {
      ...
      for (let e = 0; e < a.length; e += 4) {
        var r = String.fromCharCode(256 * a[e + 1] + a[e + 2]);
        if (((c += r), "/" == r && "*" == o)) break;
        o = r;
      }
      var [, e, i] = c.match(/LastUpdated: (.+?); ErrorMessage: "(.+?)"/);
      (parseInt(e) <= 1693429950176 || m.contentWindow.alert(i)) && t();
    }),
    (s.onerror = s.onabort = () => ((s.src = null), t()));
})();
